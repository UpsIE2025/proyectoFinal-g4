...
| ----------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Arquitectura           | Extensible a través de plugins.  Utiliza Nginx como base y una base de datos (PostgreSQL o Cassandra) para la persistencia de la configuración. Los plugins se ejecutan en el contexto del proceso Nginx.  <br> [Diagrama de Arquitectura Kong](URL del diagrama si lo tienes)                                                                                                 | Basado en Nginx y etcd.  Utiliza etcd para el almacenamiento de la configuración y permite actualizaciones dinámicas sin necesidad de reiniciar el servidor.  <br> [Diagrama de Arquitectura Apache APISIX](URL del diagrama si lo tienes)                                                                                                                               |
