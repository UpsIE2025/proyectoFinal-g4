...
class UserServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.SendMessage = channel.unary_unary(
                '/service.UserService/SendMessage',
        ...
        self.ReceiveMessages = channel.unary_stream(
                '/service.UserService/ReceiveMessages',
                request_serializer=service__pb2.Empty.SerializeToString,
                response_deserializer=service__pb2.ActionMessage.FromString,
                _registered_method=True)
        self.GetUser = channel.unary_unary(
                '/service.UserService/GetUser',
                request_serializer=service__pb2.UserIdRequest.SerializeToString,
...
def add_UserServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'ReceiveMessages': grpc.unary_stream_rpc_method_handler(
                    ...
                    response_serializer=service__pb2.ActionMessage.SerializeToString,
            ),
            'GetUser': grpc.unary_unary_rpc_method_handler(
                    servicer.GetUser,
                    request_deserializer=service__pb2.UserIdRequest.FromString,
...
class UserService(object):
    ...
    def ReceiveMessages(request,
        ...
        return grpc.experimental.unary_stream(
            ...
            service__pb2.ActionMessage.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def GetUser(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/service.UserService/GetUser',
            service__pb2.UserIdRequest.SerializeToString,
